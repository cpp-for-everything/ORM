...
namespace Moka
{
	...
	namespace must
	{
		...
		template <class A, class B> void be_equal(const char* f, int l, const A& a, const B& b, const std::string& msg = "")
		{
			if (a != b)
			{
				std::stringstream message;
		...
		template <class A, class B> void be_less(const char* f, int l, const A& a, const B& b, const std::string& msg = "")
		{
			if (!(a < b))
			{
				std::stringstream message;
		...
		template <class A, class B> void be_greater(const char* f, int l, const A& a, const B& b, const std::string& msg = "")
		{
			if (!(a > b))
			{
				std::stringstream message;
		...
		template <class A, class B> void be_not_equal(const char* f, int l, const A& a, const B& b, const std::string& msg = "")
		{
			if (a == b)
			{
				std::stringstream message;
		...
		template <class E> void throoow(const char* f, int l, const char* type, std::function<void()> fn, const std::string& msg = "")
		{
			try
			{
				fn();
