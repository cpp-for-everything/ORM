...
Една от централните претенции на разработката е, че библиотеката е надграждаема без компромис с нейните compile-time гаранции. Това изисква не просто наличие на тестове, а ясно дефиниран connector contract, който позволява нов backend да бъде добавен без промяна в query API и без разпадане на типовата дисциплина, capability ограниченията и архитектурните инварианти.

В предходните глави беше показано, че библиотеката вече работи с релационни и нерелационни backend-и, както и че async слоят може да бъде реализиран по различен начин според native възможностите на конкретния драйвер. Настоящата глава формализира как това е възможно и как трябва да се добавя следващ backend. С други думи, тук надграждаемостта престава да бъде общо качество на дизайна и се превръща в методология с конкретни изисквания, signatures, capability декларации, async obligations и критерии за завършеност.
