...
\cs_new_protected:Npn \orm_code:n #1
  {
    \group_begin:
      ...
      \regex_replace_all:nnN { \\\{ } { \c{textbraceleft} } \l__orm_code_text_tl
      \regex_replace_all:nnN { \\\} } { \c{textbraceright} } \l__orm_code_text_tl
      \regex_replace_all:nnN { < } { \c{textless} } \l__orm_code_text_tl
      \regex_replace_all:nnN { > } { \c{textgreater} } \l__orm_code_text_tl
      \mbox { \ttfamily \tl_use:N \l__orm_code_text_tl }
    \group_end:
  }
...
\begin{center}
    ...
    {\fontsize{20}{24}\selectfont\bfseries РАЗРАБОТВАНЕ НА БИБЛИОТЕКА ЗА ОБЕКТНО-РЕЛАЦИОННО КАРТОГРАФИРАНЕ ПО ВРЕМЕ НА КОМПИЛАЦИЯ\par}
...
% ============================================================================
% Глава 3: Проектиране на библиотеката
% ============================================================================
