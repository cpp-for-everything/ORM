...
public:
  static constexpr auto insert_new_user_with_id_placeholder =
      webframe::ORM::insert<&User::id, &User::username>;
  static constexpr auto insert_new_user =
      webframe::ORM::insert<&User::username>;
  static constexpr auto get_all_users_with_id_above = webframe::ORM::select<modes::ALL, &User::id, &User::username>
        .where(P<&User::id> > P<Placeholder<int>>)
        .limit(15_per_page & 5_page)
        .limit(5_page & 15_per_page)
    ;
  static constexpr auto update_with_optimized_rules =
      webframe::ORM::update(P<&User::id> = P<Placeholder<int>>,
