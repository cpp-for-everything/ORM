...
namespace pfr
{
	namespace detail
	{
		...
		template <std::size_t N> struct size_array
		{ // libc++ misses constexpr on operator[]
			...
			constexpr std::size_t count_from_opening_till_matching_parenthis_seq(
				std::size_t from, std::size_t opening_parenthis, std::size_t closing_parenthis) const noexcept
			{
		...
		template <std::size_t I, std::size_t N> constexpr std::size_t get(const size_array<N>& a) noexcept
		{
