...
/// corresponding function from pfr/ops.hpp header.
///
/// \b Example:
/// \code
///     #include <pfr/ops.hpp>
...
/// conversion operators; if no operators avalable returns
...
/// specialization avalable returns \forcedlink{hash_fields}(value).
///
