...
namespace webframe::ORM
{
    namespace details {
        ...
        class mem_ptr_wrapper<ptr> : public i_mem_ptr
        {
        public:
            ...
            constexpr operator T C::* () { return ptr; }
            static constexpr T C::* to_mem_ptr() { return ptr; }
...
#undef DEFINE_OPERATOR
    ...
    template<auto ptr>
    constexpr auto P = details::mem_ptr_wrapper<ptr>();
