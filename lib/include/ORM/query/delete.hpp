...
namespace webframe::ORM
{
	namespace details
	{
		...
		class DeleteQuery<Table, WhereClauses, Orders, Limit> : public GenericDeleteQuery<Table, WhereClauses, Orders, Limit>
		{
			...
			constexpr DeleteQuery(
				...
				: GenericDeleteQuery<Table, WhereClauses, Orders, Limit>(_rules, _orders, _limit)
			{
			}
	...
	constexpr auto delete_from = details::DeleteQuery<Table, details::type_constainer<>, details::type_constainer<>, details::type_constainer<>>({}, {}, {});
} // namespace webframe::ORM
