...
namespace webframe::ORM
{
	namespace details
	{
        ...
        protected:
			constexpr GenericUpdateQuery(typename WhereRules::tuple_equivalent _rules, typename Orders::tuple_equivalent _orders, typename Limit::tuple_equivalent _limits) : rules(_rules), orders(_orders), limits(_limits)
			{
			}
        public:
        ...
        public:
			...
			constexpr UpdateQuery(typename WhereRules::tuple_equivalent _rules, typename Orders::tuple_equivalent _orders, typename Limit::tuple_equivalent _limit) : GenericUpdateQuery<Table, WhereClauses, Orders, Limit>(_rules, _orders, _limit)
			{
			}
	...
	template <details::is_table Table> constexpr auto update = details::UpdateQuery<Table, details::type_constainer<>, details::type_constainer<>, details::type_constainer<>>({}, {}, {});
} // namespace webframe::ORM
