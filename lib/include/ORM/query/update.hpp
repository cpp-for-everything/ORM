...
namespace webframe::ORM
{
	...
	namespace details
	{
		...
		template <typename Table, typename WhereClauses, typename Orders> class UpdateQuery : public IUpdate
		{
	...
	template <details::is_table Table> constexpr auto update = details::UpdateQuery<Table, details::type_constainer<>, details::type_constainer<>>({}, {});
} // namespace webframe::ORM
