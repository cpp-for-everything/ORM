...
namespace webframe::ORM::CRUD {
    ...
    public:
        ...
        constexpr inline auto where(Ts... new_filters) const {
            ...
            return delete_query<Table, new_wheres, Ordering, Limits>(webframe::ORM::details::orm_tuple(std::tuple_cat(filters.to_tuple(), std::tuple<Ts...>(new_filters...))), ordering, limits);
        }
    ...
    public:
        ...
        constexpr inline auto limit(Ts... new_limits) const {
            ...
            return delete_query<Table, Filters, Ordering, new_limits_t>(filters, ordering, webframe::ORM::details::orm_tuple(std::tuple_cat(limits.to_tuple(), std::tuple<Ts...>(new_limits...))));
        }

        template<typename, typename, typename, typename>
        friend class delete_query;
    };
}

namespace webframe::ORM {
    template<typename Table>
    static constexpr auto deleteq = CRUD::delete_query<Table, details::orm_tuple<>, details::orm_tuple<>, details::orm_tuple<>>(details::orm_tuple(), details::orm_tuple(), details::orm_tuple());
}