...
namespace webframe::ORM
{
	...
	template <details::is_not_inheritable T, details::string_literal lit> class property<T, lit> : public details::property
	{
		protected:
		T value;
	...
	class relationship<_type, external_ref, name> : public P, public details::relationship
	{
		...
		static constexpr inline std::string_view _name()
		{
			return name.to_sv();
		}
